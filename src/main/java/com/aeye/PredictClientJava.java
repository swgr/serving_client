 ...
 */
public class PredictClientJava {
    private static final Logger logger = Logger.getLogger(PredictClientJava.class.getName());
    private final ManagedChannel channel;
    private final PredictionServiceGrpc.PredictionServiceBlockingStub blockingStub;

    // Initialize gRPC client
    public PredictClientJava(String host, int port) {
    ...
    public static void main(String[] args) {
        ...
        String host = "34.210.46.167";
        int port = 8896;
        String modelName = "aeye";
        long modelVersion = 1;
        ...
        PredictClientJava client = new PredictClientJava(host, port);
